...
type Image interface {
	...
	// GetPlatformOrDefault return platform matcher from image or with default
	GetPlatformOrDefault(defaultPlatform platforms.MatchComparer) platforms.MatchComparer
}
...
func NewImage(client *Client, i images.Image) Image {
	...
	if i.Target.Platform != nil {
		platform = platforms.Only(*i.Target.Platform)
	}
	return &image{
		client:   client,
		i:        i,
...
func (i *image) GetPlatformOrDefault(defaultPlatform platforms.MatchComparer) platforms.MatchComparer {
	if i.i.Target.Platform == nil {
		return defaultPlatform
	}
	return platforms.Only(*i.i.Target.Platform)
}
