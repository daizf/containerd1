...
type ContainerdConfig struct {
	...
	// DisableParseUsername disables parsing username/groupname to uid/gid
	// specified by the image, and delay this work to runtime. For example,
	// when using nydus snapshotter with rund, the mounts returned by nydus
	// snapshotter couldn't be mounted directly on host, we need to parse
	// /etc/{passwd,group} in rootfs in guest.
	DisableParseUsername bool `toml:"disable_parse_username" json:"disableParseUsername"`
}
...
type RegistryConfig struct {
	...
	PlainHttp *bool `toml:"plain_http" json:"plainHttp"`
}
