...
func WithNewSnapshotAndQuotaLabels(id string, i containerd.Image, diskQuota string) containerd.NewContainerOpts {
	labels := make(map[string]string)
	labels["containerd.io/snapshot/type"] = "container"
	labels["containerd.io/snapshot/disk_quota"] = diskQuota
	//labels["containerd.io/defaults/snapshotter"] = "quotaoverlayfs"
