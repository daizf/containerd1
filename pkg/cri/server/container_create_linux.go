...
func (c *criService) containerSpecOpts(config *runtime.ContainerConfig, imageConfig *imagespec.ImageConfig) ([]oci.SpecOpts, error) {
	...
	if userstr != "" {
		if c.config.ContainerdConfig.DisableParseUsername {
			specOpts = append(specOpts, customopts.WithAnnotation(annotations.ImageUser, userstr))
		} else {
	...
	if c.config.ContainerdConfig.DisableParseUsername {
		specOpts = append(specOpts, customopts.WithAnnotation(annotations.ImageGids, userstr))
	} else {
